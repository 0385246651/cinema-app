...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-gradient-to-br from-[#0f0f2a] to-[#050510] rounded-3xl border border-white/10 shadow-2xl shadow-violet-500/10 overflow-hidden">
        {/* Close Button */}
        <button
          onClick={onClose}
